...
void loop() 
  ...
  if (request.indexOf("/reboot1") != -1)  {
   ...
   if (request.indexOf("/reboot5") != -1)  {
    digitalWrite(Rst5, LOW);
    delay(3000);
    digitalWrite(Rst5, HIGH);
    todo="HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n<!DOCTYPE HTML>\r\n<html>\r\nDevice Rebooted";
    todo+="</html>\n";
    client.print(todo);
  }
   if (request.indexOf("/reboot6") != -1)  {
    digitalWrite(Rst6, LOW);
    delay(3000);
    digitalWrite(Rst6, HIGH);
    todo="HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n<!DOCTYPE HTML>\r\n<html>\r\nDevice Rebooted";
    todo+="</html>\n";
    client.print(todo);
  }
   if (request.indexOf("/reboot7") != -1)  {
    digitalWrite(Rst7, LOW);
    delay(3000);
    digitalWrite(Rst7, HIGH);
    todo="HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n<!DOCTYPE HTML>\r\n<html>\r\nDevice Rebooted";
    todo+="</html>\n";
    client.print(todo);
  }
   if (request.indexOf("/reboot8") != -1)  {
    digitalWrite(Rst8, LOW);
    delay(3000);
    digitalWrite(Rst8, HIGH);
    todo="HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n<!DOCTYPE HTML>\r\n<html>\r\nDevice Rebooted";
    todo+="</html>\n";
    client.print(todo);
  }
